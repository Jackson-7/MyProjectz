...
<head>
  ...
  <title>360 Therapy Consultation-Form</title>
  <!-- fonts -->
    <?php
    ...
    if(isset($_POST['online_the']))
    {
        ...
        $_SESSION['p_page']="therapy";
        $_SESSION['p_email']=$email;
        $_SESSION['p_amount']="300";
        $_SESSION['p_name']=$name;
        therapist($email,$name,$phone,$medic_in,$medic_his,$symptom,$schedule);
    }
    ?>
</head>
...
<body>
  ...
  <div class="container" >
    ...
    <!-- Heading -->
<div class="container" style="color: #050E32;margin-top: 1.5em;text-shadow: 0 3px 3px rgba(0, 0, 0, 0.452);">
    ...
    <div style="position: absolute;" >
      <img src="images/franchise_form_bg.png" style="width: 69.4em; height: 70em; margin-top: 1em;box-shadow: 0 8px 8px 0 rgba(0, 0, 0, 0.521);  " alt="">
    </div>
           ...
           <div class="col-2" style="margin-top: 2em; ">
            <div class="card" style="width: 45rem; margin-left: 1em; background:rgba( 255, 255, 255, 0.25 );box-shadow:0 8px 32px 0 rgba( 31, 38, 135, 0.37 );backdrop-filter:blur( 11.0px );-webkit-backdrop-filter:blur( 11.0px );border-radius:10px; color:white;">
                <div class="card-header">
                  <h2>Book An Appointment with Therapist</h2>
                  <p>Take care of your mental and emotional fitness in a safe,calm and non-judgmental environment.</p>
                </div>
                <ul class="list-group list-group-flush" style="padding: 2em;">
                    <form action="" method="post">
                        ...
                        <div class="mb-3">
                          ...
                          <div class="mb-3">
                            <label  class="form-label">Synmptoms</label>
                        ...
                        <div class="mb-3">
                          ...
                          <button type="submit" name="online_the" class="btn btn-primary" style="width: 20em; margin-left: 7.8em;" >Proceed</button>
                        </form>
