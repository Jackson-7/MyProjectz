...
<body>
  ...
  <div class="container" >
      ...
      <!-- Heading -->
<div class="container" style="color: #050E32;margin-top: 1.5em;text-shadow: 0 3px 3px rgba(0, 0, 0, 0.479);">
    ...
    <div style="position: absolute;" >
      <img src="images/franchise_form_bg.png" style="width: 69.4em; height: 54em; margin-top: 1em; box-shadow: 0 8px 8px 0 rgba(0, 0, 0, 0.534);  " alt="">
    </div>
           ...
           <div class="col-2" style="margin-top: 2em; ">
            <div class="card" style="width: 45rem; margin-left: 1em; background:rgba( 255, 255, 255, 0.25 );box-shadow:0 8px 32px 0 rgba( 31, 38, 135, 0.37 );backdrop-filter:blur( 11.0px );-webkit-backdrop-filter:blur( 11.0px );border-radius:10px; color:white;">
                <div class="card-header">
                  <h2 style="text-align: center;">Book Training Session</h2>
                </div>
                <ul class="list-group list-group-flush" style="padding: 2em;">
                    <form action="" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="fullname" name="phone" class="form-control">
                        </div>

                        <label  class="form-label">Plan </label>
                          <div class="input-group mb-3">

                            <select class="form-select form-control" name="plan" id="inputGroupSelect02">
                              <option selected value="Home-workout Plan" > Home-workout Plan</option>
                              <option value="Personal Training">Personal Training</option>
                              <option value="Yoga Plan">Yoga Plan</option>
                              <option value="Zumba Plan">Zumba Plan</option>
                              <option value="Calisthenics Plan">Calisthenics Plan</option>
                              <option value="Weight Training">Weight Training</option>
                            </select>
                            <label class="input-group-text" for="inputGroupSelect02"> Type Of Training</label>
                          </div>
                          ...
                          <button class="btn btn-primary" type="submit" name="gym_form" style="width: 20em; margin-left: 8em;" >Proceed</button>
                        </form>
