<nav class="navbar navbar-expand-xl " style="background-color: #050E32 ;">
    ...
    <div class="collapse navbar-collapse navbar-fluid" id="navbarTogglerDemo02">
        <ul class="navbar-nav ml-auto  mt-lg-0 mr-3">
            <li class="nav-item active" style="margin-top:0.4em; font-size:22px;">
                <a class="nav-link mr-3" style="color:#fff;" href="mainpg.php">Home <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item" style="margin-top:0.4em; font-size:22px;">
                <a class="nav-link mr-3" style="color:#fff"  href="franchise_form.php">Franchise</a>
            </li>
            <li class="nav-item" style="margin-top:0.4em; font-size:22px;">
