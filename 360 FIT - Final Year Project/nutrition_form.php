...
<head>
  ...
  <title>360 Nutriion Consultation-Form</title>
  <!-- fonts -->
    <?php
    ...
    if(isset($_POST['nutri_form']))
    {
        ...
        $symptom = $_POST['b_weight'];
        $schedule = $_POST['schedule'];
        $_SESSION['p_phone']=$phone;
        $_SESSION['p_page']="nutrition";
        $_SESSION['p_email']=$email;
        $_SESSION['p_amount']="300";
        $_SESSION['p_name']=$name;
        nutriform($email,$name,$phone,$medic_in,$medic_his,$symptom,$schedule);
...
<body>
  ...
  <div class="container" >
    ...
    <!-- Heading -->
<div class="container" style="color: #050E32;margin-top: 1.5em;text-shadow: 0 3px 3px rgba(0, 0, 0, 0.486);">
    ...
    <div style="position: absolute;" >
      <img src="images/franchise_form_bg.png" style="width: 69.4em; height: 67em; margin-top: 1em; box-shadow: 0 8px 8px 0 rgba(0, 0, 0, 0.507); " alt="">
    </div>
           ...
           <div class="col-2" style="margin-top: 2em; ">
            <div class="card" style="width: 45rem; margin-left: 1em; background:rgba( 255, 255, 255, 0.25 );box-shadow:0 8px 32px 0 rgba( 31, 38, 135, 0.37 );backdrop-filter:blur( 11.0px );-webkit-backdrop-filter:blur( 11.0px );border-radius:10px; color:white;">
                <div class="card-header">
                  <h2>Book An Appointment with Nutrionist</h2>
                </div>
                    ...
                    <form method="post" action="">
                        ...
                        <div class="mb-3">
                          ...
                          <div class="mb-3">
                            ...
                            <input type="number" name="b_weight" id="age" class="form-control">
                          </div>
                        ...
                        <div class="mb-3">
                          ...
                          <div class="mb-3">
                            ...
                            <input type="datetime-local" name="schedule" id="date_time" class="form-control">
                          </div>
                          <button class="btn btn-primary" name="nutri_form" style="width: 20em; margin-left: 7.8em;" >Proceed</button>
                        </form>
