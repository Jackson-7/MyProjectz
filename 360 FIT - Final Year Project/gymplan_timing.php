...
<body>
  ...
  <div class="container" >
    ...
    <!-- Heading -->
<div class="container" style="color: #050E32;margin-top: 1.5em; text-shadow: 0 3px 3px rgba(0, 0, 0, 0.473);">
    ...
    <div style="position: absolute;" >
      <img src="images/franchise_form_bg.png" style="width: 69.4em; height: 44em; margin-top: 1em; box-shadow: 0 8px 8px 0 rgba(0, 0, 0, 0.459);  " alt="">
    </div>
           ...
           <div class="col-2" style="margin-top: 2em; ">
            <div class="card" style="width: 45rem; margin-left: 1em;">
                <div class="card-header">
                  <h2 style="margin-left: 5em;" >Choose a Time Slot</h2>
                  
                </div>
                <ul class="list-group list-group-flush" style="padding: 2em;">    
                    <button type="submit" class="btn btn-outline-secondary" style=" margin-top: 1em; width: 20em; margin-left: 8em;" >9:00 - 11:00</button>
                    <button type="submit" class="btn btn-outline-secondary" style=" margin-top: 1em; width: 20em; margin-left: 8em;" >4:00 - 18:00</button>
                    <button type="submit" class="btn btn-outline-secondary" style="width: 20em; margin-left: 8em; margin-top: 1em; " >19:00 - 21:00</button>
                    <div class="mb-3">
