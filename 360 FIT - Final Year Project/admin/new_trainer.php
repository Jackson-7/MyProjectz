        ...
        if($result){
            {
                ...
                $body = "Hi, This is Jackson from 360_fit a pro fitness app you have been selected as new trainee login email:'.$to_email.' password:'.$pass.'";
                $headers = "From: Jackson 360-fit";

                if (mail($to_email, $subject, $body, $headers)) {
                    echo "<script language='javascript'>";
                    echo 'alert("New Trainer Added Successfully, details will be sent to email '.$to_email.'");';
                    echo 'window.location.replace("new_trainer.php");';
                    echo "</script>";
                } else {
