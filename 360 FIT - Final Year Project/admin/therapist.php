...
<head>
    ...
    if(isset($_SESSION['role'])){
        ...
        elseif($_SESSION["role"]=="Doctor"){header( "location:therapist.php");}
    ...
    if(isset($_GET['delete'])){
        ...
        $result = mysqli_query($conn,"DELETE FROM `therapy` WHERE `id`='$id'");
        if($result){
            echo "<script language='javascript'>";
            echo 'alert("Deleted Successfully");';
            echo 'window.location.replace("therapist.php");';
            echo "</script>";
        }else{
            echo "<script language='javascript'>";
    ...
    if(isset($_GET['accept'])){
        ...
        $status="Accepted";
        $conn = mysqli_connect('localhost','root','','360_fit') or die('unable to connect');
        $result = mysqli_query($conn,"UPDATE `therapy` SET `status`='$status' WHERE `id`='$id'");
        if($result){
            echo "<script language='javascript'>";
