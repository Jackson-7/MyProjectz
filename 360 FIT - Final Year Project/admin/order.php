...
<head>
    ...
    if(isset($_GET['proceed'])){
        $id=$_GET['proceed'];
        $conn = mysqli_connect('localhost','root','','360_fit') or die('unable to connect');
        $result = mysqli_query($conn,"UPDATE `order_list` SET `status`='Ready to ship' WHERE `id` = '$id'");
        if($result){
            echo "<script language='javascript'>";
    ...
    if(isset($_GET['send'])){
        $id=$_GET['send'];
        $conn = mysqli_connect('localhost','root','','360_fit') or die('unable to connect');
        $result = mysqli_query($conn,"UPDATE `order_list` SET `status`='Order on its way' WHERE `id` = '$id'");
        if($result){
            echo "<script language='javascript'>";
            echo 'alert("Updated Successfully");';
        ...
        <div class="content">
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="title">Cancel Order list</h5>
                        </div>
                        <div class="card-body">
