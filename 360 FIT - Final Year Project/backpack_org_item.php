            ...
            <div class="wrapper row">
                <div class="preview col-md-6">
                    ...
                    <div class="preview-pic tab-content">
                      <div class="tab-pane active" id="pic-1"><img src="images/backpack_orange.jpg" /></div>
                      <div class="tab-pane" id="pic-2"><img src="images/backpack_orange_2.jpg" /></div>
                      <div class="tab-pane" id="pic-3"><img src="images/backpack_orange_3.jpg" /></div>
                      <div class="tab-pane" id="pic-4"><img src="images/backpack_orange_4.jpg" /></div>
                      <div class="tab-pane" id="pic-5"><img src="images/backpack_orange_5.jpg" /></div>
                    </div>
                    <ul class="preview-thumbnail nav nav-tabs">
                      <li class="active"><a data-target="#pic-1" data-toggle="tab"><img src="images/backpack_orange.jpg" /></a></li>
                      <li><a data-target="#pic-2" data-toggle="tab"><img src="images/backpack_orange_2.jpg" /></a></li>
                      <li><a data-target="#pic-3" data-toggle="tab"><img src="images/backpack_orange_3.jpg" /></a></li>
                      <li><a data-target="#pic-4" data-toggle="tab"><img src="images/backpack_orange_4.jpg" /></a></li>
                      <li><a data-target="#pic-5" data-toggle="tab"><img src="images/backpack_orange_5.jpg" /></a></li>
                    </ul>
                ...
                <div class="details col-md-6">
                    ...
                    <h4 class="price">Current Price: <span>Rs. 3,500</span></h4>
                    <form action="" method="post">
                        <input type="text" name="name" class="form-control" value="Backpack" hidden>
                        <input type="text" name="price" class="form-control" value="3500" hidden>
                        <input type="text" name="image" class="form-control" value="images/backpack_orange.jpg" hidden>
                        <div class="row mb-2">
